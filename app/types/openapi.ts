export interface paths {
  ...
  "/talksessions/{talkSessionID}/analysis/toggle": {
    ...
    /**
     * 分析設定をトグル
     * @description 分析の有効/無効をトグルする
     *
     *     分析を有効にすると（disableAnalysis: true → false）、自動的に分析処理が開始されます。
     */
    put: operations["toggleTalkSessionAnalysis"];
    post?: never;
    delete?: never;
    options?: never;
    head?: never;
